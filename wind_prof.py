...
v_max = 95
wr34 = np.array([80, 110, 130, 110])
wr50 = np.array([40,  60,  80, 60])
wr64 = np.array([20,  30,  40, 30])
min_r_max = np.min(wr64)/4.
...
bou = [(min_a,max_a),(min_r_max, 2*min_r_max), \
      (min_b,max_b), (min_b,max_b), (min_b,max_b), (min_b,max_b), \
      (min_b,max_b), (min_b,max_b), (min_b,max_b), (min_b,max_b), \
      (min_b,max_b), (min_b,max_b), (min_b,max_b), (min_b,max_b), \
      (min_b,max_b), (min_b,max_b), (min_b,max_b), (min_b,max_b), \
